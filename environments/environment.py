...
class Environment:
    ...
    def step(self, action, state):
        ...
        pre_swap_reward = self.schedule_gates((qubit_locations, qubit_targets, circuit_progress, protected_nodes))
        # can serve reward here

        # total_pre_swap_distance = sum([self.calculate_gate_distance(gate, qubit_locations)
        #                                for gate in self.next_gates(qubit_targets)])
        ...
        # total_post_swap_distance = sum([self.calculate_gate_distance(gate, qubit_locations)
        #                                 for gate in self.next_gates(qubit_targets)])
