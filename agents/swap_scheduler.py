...
def schedule_swaps(environment, agent, circuit=None, experience_db=None, qubit_locations=None,
                   safety_checks_on=False, decompose_cnots=False):
    ...
    scheduled_circuit = NodeCircuit.from_gates(environment.number_of_nodes,
                                               total_gates_scheduled, decompose=decompose_cnots)
